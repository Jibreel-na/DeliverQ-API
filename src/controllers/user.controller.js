...
const createUser = catchAsync(async (req, res) => {
  ...
  if (req.body.role === driver) {
    emailService.sendEmail(req.body.email, i18next.t('Welcome to DelierQ'), '<p>' + i18next.t('Hi') + ' ' + req.body.first_name + '<br/> ' + i18next.t('Your account is created by deliverQ. please use the below credentials to log in to your account, please log in to DeliverQ app') +
    ...
    emailService.sendEmail(req.body.email, i18next.t('Welcome to DelierQ'), '<p>' + i18next.t('Hi') + ' ' + req.body.first_name + '<br/> ' + i18next.t('Your account is created by deliverQ. please use the below credentials to log in to your account, click here to open dashboard') +
...
const updatePassword = catchAsync(async (req, res) => {
  ...
  await authService.checkUserWithEmailAndPassword(req.user.email, req.body.old_password);
  await authService.changePassword(req.user.id, req.body.new_password);
